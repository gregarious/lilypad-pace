...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BehaviorIncident.last_modified_at'
        db.add_column(u'pace_behaviorincident', 'last_modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PeriodicRecord.last_changed_at'
        db.add_column(u'pace_periodicrecord', 'last_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 13, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pace_behaviorincident', 'last_modified_at')

        # Deleting field 'PeriodicRecord.last_changed_at'
        db.delete_column(u'pace_periodicrecord', 'last_changed_at')
