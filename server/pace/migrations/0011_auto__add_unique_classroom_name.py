...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Classroom', fields ['name']
        db.create_unique(u'pace_classroom', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Classroom', fields ['name']
        db.delete_unique(u'pace_classroom', ['name'])
