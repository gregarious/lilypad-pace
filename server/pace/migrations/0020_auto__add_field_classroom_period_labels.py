...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.period_labels'
        db.add_column(u'pace_classroom', 'period_labels',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.period_labels'
        db.delete_column(u'pace_classroom', 'period_labels')
    ...
    models = {
        ...
        u'pace.classroom': {
            ...
            'period_labels': ('django.db.models.fields.TextField', [], {}),
