...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.permissions_group'
        db.add_column(u'pace_classroom', 'permissions_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.permissions_group'
        db.delete_column(u'pace_classroom', 'permissions_group_id')
