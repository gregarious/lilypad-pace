...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PeriodicRecord.is_eligible'
        db.delete_column(u'pace_periodicrecord', 'is_eligible')


    def backwards(self, orm):
        # Adding field 'PeriodicRecord.is_eligible'
        db.add_column(u'pace_periodicrecord', 'is_eligible',
