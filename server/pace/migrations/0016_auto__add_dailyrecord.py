...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyRecord'
        db.create_table(u'pace_dailyrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('classroom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pace.Classroom'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('current_period', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'pace', ['DailyRecord'])


    def backwards(self, orm):
        # Deleting model 'DailyRecord'
        db.delete_table(u'pace_dailyrecord')
