...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.classroom'
        db.alter_column(u'pace_student', 'classroom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pace.Classroom'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Student.classroom'
        raise RuntimeError("Cannot reverse this migration. 'Student.classroom' and its values cannot be restored.")
