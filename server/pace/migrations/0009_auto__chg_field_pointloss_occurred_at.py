...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PointLoss.occurred_at'
        db.alter_column(u'pace_pointloss', 'occurred_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'PointLoss.occurred_at'
        db.alter_column(u'pace_pointloss', 'occurred_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
