...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaffProfile'
        db.create_table(u'pace_staffprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'pace', ['StaffProfile'])

        # Adding M2M table for field classrooms on 'StaffProfile'
        m2m_table_name = db.shorten_name(u'pace_staffprofile_classrooms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('staffprofile', models.ForeignKey(orm[u'pace.staffprofile'], null=False)),
            ('classroom', models.ForeignKey(orm[u'pace.classroom'], null=False))
        ))
        db.create_unique(m2m_table_name, ['staffprofile_id', 'classroom_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'StaffProfile'
        db.delete_table(u'pace_staffprofile')

        # Removing M2M table for field classrooms on 'StaffProfile'
        db.delete_table(db.shorten_name(u'pace_staffprofile_classrooms'))
