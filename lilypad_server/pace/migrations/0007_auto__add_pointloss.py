...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PointLoss'
        db.create_table(u'pace_pointloss', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('occurred_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('periodic_record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pace.PeriodicRecord'])),
            ('point_type', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'pace', ['PointLoss'])


    def backwards(self, orm):
        # Deleting model 'PointLoss'
        db.delete_table(u'pace_pointloss')
